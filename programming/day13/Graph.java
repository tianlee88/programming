public class Graph<N,W> implements IGraph<N,W>
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println(g.getNeighbors(g.fetchNode("1"))[0]);
        System.out.println(g.getNeighbors(g.fetchNode("1"))[1]);
        System.out.println(g.getNeighbors(g.fetchNode("1"))[2]);
        System.out.println(g.fetchNode("2"));
        System.out.println(g.fetchNode("3"));
        System.out.println(g.fetchNode("4"));
